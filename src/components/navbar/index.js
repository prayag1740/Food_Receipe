...
export default function NavBar() {
  ...
  return (
    ...
    <input type='text' name='search' value={searchParam} onChange={(event) => setSearchParams(event.target.value)} placeholder='Enter Items ... ' className='bg-white/75 p-3 px-8 rounded-full outline-none lg:w-96 shadow-lg shadow-red-100 focus:shadow-red-200' />
    </form>
